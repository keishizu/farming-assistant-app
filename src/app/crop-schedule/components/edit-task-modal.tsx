...
export function EditTaskModal({ isOpen, onClose, task, onUpdate }: EditTaskModalProps) {
  ...
  const handleSave = () => {
    ...
    if (taskName.length > 20) {
      const { dismiss } = toast({
        title: "エラー",
        description: "作業名は20文字以内で入力してください",
        variant: "destructive",
        duration: 5000,
        onClick: () => dismiss(),
      });
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="作業名を入力してください（20文字以内）"
              maxLength={20}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            >
              <option value="field">畑作業</option>
              <option value="greenhouse">ハウス作業</option>
